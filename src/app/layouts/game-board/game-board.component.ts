...
export class GameBoardComponent implements OnInit, AfterViewInit {
  ...
  private adjustBoardHeight(): void {
    ...
    console.log(`Adjusted board: container=${containerHeight}, title=${titleHeight}, players=${playersHeight}, cell=${cellHeight}, availableHeight=${availableHeight}, rowCount=${rowCount}`);
  }
